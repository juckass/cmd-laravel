    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body ">
                    <form method="POST" action="{{ route('editar.paginas') }}">
                        @csrf

                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="nombre_pagina" class="col-md-4"><b>{{ __('Nombre Pagina') }}</b></label>
                                <input id="nombre_pagina" type="text" class="form-control" name="titulo" value="{{$pagina->titulo}}" required autocomplete="nombre_pagina" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input id="slug" type="text" class="form-control" name="slug" value="{{$pagina->slug}}" required autocomplete="nombre_pagina" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id= "head" class="form-control" rows="6" style="width: 100%;" name="head">
                            {{$pagina->head}}
                            </textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id= "cuerpo" class="ckeditor form-control" name="body">
                                {{$pagina->body}}
                            </textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id= "footer" class="form-control" rows="6" style="width: 100%;" name="footer">
                            {{$pagina->footer}}
                            </textarea>
                        </div>
